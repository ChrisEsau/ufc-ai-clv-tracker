# ============================================================
# UFC LIVE PREDICTION PIPELINE V4 — CLEAN REBUILD
# ============================================================

!pip install beautifulsoup4 joblib requests -q
...
# ============================================================
# SELENIUM SETUP FOR COLAB — UFCSTATS COMPATIBLE
# ============================================================

!apt-get update -qq
!wget -q https://dl.google.com/linux/direct/google-chrome-stable_current_amd64.deb
!apt install -y ./google-chrome-stable_current_amd64.deb
!pip install selenium webdriver-manager lxml -q
...
# ============================================================
# TEST UFCSTATS PAGE LOAD
# ============================================================

import time
from bs4 import BeautifulSoup

test_url = "http://ufcstats.com/statistics/events/upcoming"
...
# ============================================================
# SECTION 7 — SCRAPE UPCOMING UFCSTATS CARD WITH SELENIUM
# ============================================================
...
driver.get(UFCSTATS_UPCOMING_URL)
time.sleep(8)
