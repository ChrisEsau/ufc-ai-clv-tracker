...
def main() -> None:
    ...
    print(
        ...
        f"calibration {args.calibration_start}..< {args.test_start} | test >= {args.test_start}"
    )
    print("Loading longitudinal external MMA history and building leakage-safe cross-promotion Elo...")
