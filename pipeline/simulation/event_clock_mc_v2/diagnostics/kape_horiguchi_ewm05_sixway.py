"""Manel Kape vs Kyoji Horiguchi pure-EWM 0.50 shadow with explicit six-way methods."""
...
def main() -> None:
    ...
    try:
        ...
        payload = {
            "diagnostic": "Kape-Horiguchi pure EWM 0.50 six-way shadow",
            "fight_id": fight_id,
            "paths": PATHS,
            "ewm_decay": EWM_DECAY,
            "canonical_blend": 0.0,
        ...
        print("KAPE_HORIGUCHI_EWM05_SIXWAY")
