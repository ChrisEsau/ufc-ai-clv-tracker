...
def main():
 ...
 for fi,(fight,rf,bf) in enumerate(chosen):
  ...
  inp=EngineInputs(FighterEngineInputs(rc,BrainTimingContext(),BrainDecisionContext(),_mechanics(rr)),FighterEngineInputs(bc,BrainTimingContext(),BrainDecisionContext(),_mechanics(br)))
  chooser=IntentPriorChooser({Side.RED:BrainIntentPriors(rr.standing_rate_15m,rr.takedown_rate_15m,a.clinch_ratio),Side.BLUE:BrainIntentPriors(br.standing_rate_15m,br.takedown_rate_15m,a.clinch_ratio)})
