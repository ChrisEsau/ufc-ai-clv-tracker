"""Allen vs Shahbazyan pure-EWM 0.50 shadow with explicit six-way methods.
...
pure-EWM grid. The only FSR intervention is pure EWM decay=0.50 with no
canonical blend.
"""
...
def main() -> None:
    ...
    try:
        ...
        payload = {
            "diagnostic": "Allen-Shahbazyan pure EWM 0.50 six-way shadow",
            "fight_id": FIGHT_ID,
            "paths": PATHS,
            "ewm_decay": EWM_DECAY,
            "canonical_blend": 0.0,
        ...
        print("ALLEN_SHAHBAZYAN_EWM05_SIXWAY")
