"""Leavitt vs Brito pure-EWM 0.50 shadow with explicit six-way methods.
...
def main() -> None:
    ...
    try:
        ...
        payload = {
            "diagnostic": "Leavitt-Brito pure EWM 0.50 six-way shadow",
            "fight_id": FIGHT_ID,
            "paths": PATHS,
            "ewm_decay": EWM_DECAY,
            "canonical_blend": 0.0,
        ...
        print("LEAVITT_BRITO_EWM05_SIXWAY")
