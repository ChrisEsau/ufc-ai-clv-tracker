"""Research-only Brendan Allen vs Edmen Shahbazyan Brain shadow at calibrated standing cadence.
...
def main() -> None:
    ...
    payload = {
        "diagnostic": "Allen-Shahbazyan calibrated Brain standing-attempt shadow",
        "fight_id": FIGHT_ID,
        "paths": PATHS,
    ...
    print("ALLEN_SHAHBAZYAN_CALIBRATED_ATTEMPT_SHADOW")
