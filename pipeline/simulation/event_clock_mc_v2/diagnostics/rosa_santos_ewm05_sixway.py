"""Karol Rosa vs Luana Santos pure-EWM 0.50 shadow with explicit six-way methods."""
...
FIGHTER_A = "Karol Rosa"
FIGHTER_B = "Luana Santos"
...
def main() -> None:
    ...
    try:
        ...
        payload = {
            "diagnostic": "Rosa-Santos pure EWM 0.50 six-way shadow",
            "fight_id": fight_id,
            "paths": PATHS,
            "ewm_decay": EWM_DECAY,
            "canonical_blend": 0.0,
        ...
        print("ROSA_SANTOS_EWM05_SIXWAY")
