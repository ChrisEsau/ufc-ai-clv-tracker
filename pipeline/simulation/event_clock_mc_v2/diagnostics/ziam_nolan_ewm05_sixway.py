"""Ziam vs Nolan pure-EWM 0.50 shadow with explicit six-way methods.

Research only. Same fight, 500 matched seeds, 0.25 standing-attempt scale,
dynamic pressure, mechanics, judging, and event-clock behavior as the completed
Allen/Shahbazyan pure-EWM 0.50 setup. The only FSR intervention is pure EWM
decay=0.50 with no canonical blend.
"""
...
def main() -> None:
    ...
    try:
        ...
        payload = {
            "diagnostic": "Ziam-Nolan pure EWM 0.50 six-way shadow",
            "fight_id": FIGHT_ID,
            "paths": PATHS,
            "ewm_decay": EWM_DECAY,
            "canonical_blend": 0.0,
